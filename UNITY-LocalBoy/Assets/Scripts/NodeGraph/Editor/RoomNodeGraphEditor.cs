...
{
    private GUIStyle roomNodeStyle, roomNodeSelectedStyle;
    ...
    private void OnEnable()
    {
        ...
        roomNodeStyle.normal.background = EditorGUIUtility.Load("node0") as Texture2D;
        ...
        roomNodeSelectedStyle.normal.background = EditorGUIUtility.Load("node0 on") as Texture2D;
    ...
    private void DrawConnectionLine(RoomNodeSO parentRoomNode, RoomNodeSO childRoomNode)
    {
        ...
        Handles.DrawBezier(startPosition, endPosition, startPosition, endPosition, Color.white, null, connectingLineWith);
        ...
        // Calculate normalized perpendicular vector positions form the mid point
        ...
        //Draw Arrow
        Handles.DrawBezier(arrowHeadPoint, arrowTailPoint1, arrowHeadPoint, arrowTailPoint1, Color.white, null, connectingLineWith);
        Handles.DrawBezier(arrowHeadPoint, arrowTailPoint2, arrowHeadPoint, arrowTailPoint2, Color.white, null, connectingLineWith);
    ...
    private void DrawDragLine()
    {
        if (currentRoomNodeGraph.linePosition != Vector2.zero)
        {
            ...
            Handles.DrawBezier(currentRoomNodeGraph.roomNodeToDrawLineFrom.rect.center, currentRoomNodeGraph.linePosition,
                currentRoomNodeGraph.roomNodeToDrawLineFrom.rect.center, currentRoomNodeGraph.linePosition, Color.red, null, connectingLineWith);
        }
    }
    ...
    /// <summary>
    /// Check to see mouse is over a room node - if so return the room node else return null
    /// </summary>
    ...
    private void ProcessMouseUpEvent(Event currentEvent)
    {
        ...
        if (currentEvent.button == 1 && currentRoomNodeGraph.roomNodeToDrawLineFrom != null)
        {
            ...
            if (roomNode != null)
            {
                // If possible, set it as a child of the parent room node.
                if (currentRoomNodeGraph.roomNodeToDrawLineFrom.AddChildRoomNodeIDToRoomNode(roomNode.id))
                {
                    // Set parent ID in room node
    ...
    private void ProcessMouseDragEvent(Event currentEvent)
    {
        ...
        else if (currentEvent.button == 000)
        {
    ...
    /// <summary>
    /// Process right mouse event - draw line
    /// </summary>
    ...
    /// <summary>
    /// Precess mouse down events on the room node graph (not over a node)
    /// </summary>
    ...
    private void CreateRoomNode(object mousePositionObject, RoomNodeTypeSO roomNodeType)
    {
        ...
        roomNode.Initialize(new Rect(mousePosition, new Vector2(nodeWidth, nodeHight)), currentRoomNodeGraph, roomNodeType);
